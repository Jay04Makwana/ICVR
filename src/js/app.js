  ...
  $(() => {
    ...
    if (document.querySelector('.js-menu')) {
      ...
      menuItems.click(function (e) {
        ...
        const offsetTop = href === '#' ? 0 : $(href).offset().top - 49;
...
// Onclick submenu
$('#introSection').hide();
$(document).on('click', '#immersive', (event) => {
...
$(document).on('click', '#bookconsultation', (event) => {
  event.preventDefault();
  $('.backgroundVideo').show(0, () => {
...
function scrollStudies() {
  ...
  $(window).on('scroll', () => {
    const scroll = $(window).scrollTop();
    const ihs = $('#intro-home-section').height();
    if (scroll > ihs - 200) {
      if (x === 0) {
        $('.tag1').css({
          opacity: 0,
...
function scrollAwards() {
  ...
  $(window).on('scroll', () => {
    const scroll = $(window).scrollTop();
    const ihs = $('.studies-section').height() + $('#intro-home-section').height();
    if (scroll > ihs) {
      if (x === 0) {
        $('#award1').css({
...
function scrollNews() {
  ...
  $(window).on('scroll', () => {
    const scroll = $(window).scrollTop();
    const ihs = $('.awards-section').height() + $('.studies-section').height() + $('#intro-home-section').height();
    if (scroll > ihs) {
      if (x === 0) {
        /* $('.newsSlide1').css({
